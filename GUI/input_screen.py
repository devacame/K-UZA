...
class InputScreen(QWidget):
    ...
    def initUI(self):
        ...
        grid.addWidget(self.json_upload_btn, 0, 2)
        grid.addWidget(self.target_lang, 1, 0)
        grid.addWidget(QLabel(), 1, 1)
        grid.addWidget(self.manual_lang, 1, 2)
        grid.addWidget(QLabel(), 2, 0)
        grid.addWidget(self.submit_btn, 2, 1)
        grid.addWidget(QLabel(), 2, 2)
        self.search_bar_groupbox.setLayout(grid)

        g = QGridLayout()
        g.addWidget(self.search_bar_groupbox)
